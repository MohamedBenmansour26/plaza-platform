    ...
    <div className="min-h-screen bg-[#FAFAF9] flex flex-col items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center space-y-4">
          ...
          {(order.paymentMethod === 'cash' || order.paymentMethod === 'card-delivery') && (
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              ...
              <p className="text-[13px] text-[#166534] leading-snug">
                Paiement à la livraison — vous ne payez qu&apos;au moment de recevoir votre colis.
                Aucun montant n&apos;est débité maintenant.
              </p>
            </motion.div>
          )}
